...
const B2_DATASET = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "french": "Lorsque le rapport parut, plusieurs observateurs soulignèrent immédiatement les limites de la méthode employée.",
      "japanese": "報告書が公表されると、複数の専門家が用いられた方法の限界をただちに指摘した。",
      "points": [
        "parut, soulignèrent = 単純過去",
        "報道・歴史的叙述の書き言葉"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "単純過去・接続法半過去",
      "french": "Le gouvernement annonça la réforme au printemps, mais il fallut plusieurs mois avant que les premières mesures entrassent en vigueur.",
      "japanese": "政府は春に改革を発表したが、最初の措置が施行されるまで数か月を要した。",
      "points": [
        "annonça, fallut = 単純過去",
        "entrassent = entrer の接続法半過去"
      ]
    },
    {
      "id": 353,
      "level": "B2",
      "category": "単純過去・接続法半過去",
      "french": "À mesure que la crise s'aggrava, les autorités prirent des décisions qu'elles avaient jusque-là refusé d'envisager.",
      "japanese": "危機が深刻化するにつれ、当局はそれまで検討を拒んでいた決定を下した。",
      "points": [
        "s'aggrava, prirent = 単純過去",
        "à mesure que = 〜するにつれて"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "単純過去・接続法半過去",
      "french": "Il ouvrit les archives, consulta les lettres une à une et comprit enfin pourquoi l'affaire avait été classée.",
      "japanese": "彼は資料庫を開き、手紙を一通ずつ調べ、なぜその事件が処理済みとされたのかをようやく理解した。",
      "points": [
        "ouvrit, consulta, comprit = 単純過去",
        "plus-que-parfait との組み合わせ"
      ]
    },
    {
      "id": 355,
      "level": "B2",
      "category": "単純過去・接続法半過去",
      "french": "La découverte suscita un vif débat, puis donna lieu à une série d'études contradictoires.",
      "japanese": "その発見は激しい議論を引き起こし、その後、相反する一連の研究につながった。",
      "points": [
        "suscita, donna = 単純過去",
        "donner lieu à = 〜を生じさせる"
      ]
    },
    {
      "id": 356,
      "level": "B2",
      "category": "単純過去・接続法半過去",
      "french": "Le règlement exigeait que toute modification fût approuvée par les deux parties.",
      "japanese": "規則では、いかなる変更も双方によって承認されることが求められていた。",
      "points": [
        "fût approuvée = 接続法半過去の受動態",
        "exiger que + 接続法"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "単純過去・接続法半過去",
      "french": "Encore fallait-il que le candidat eût suffisamment d'expérience pour que sa demande fût retenue.",
      "japanese": "さらに、申請が採用されるには候補者に十分な経験がある必要があった。",
      "points": [
        "eût = avoir の接続法半過去",
        "fût retenue = 接続法半過去"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "単純過去・接続法半過去",
      "french": "Le juge ordonna que le témoin comparût de nouveau le lendemain.",
      "japanese": "裁判官は証人に翌日もう一度出廷するよう命じた。",
      "points": [
        "comparût = comparaître の接続法半過去",
        "ordonner que + 接続法"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "単純過去・接続法半過去",
      "french": "Bien qu'il fût conscient des risques, il poursuivit l'expérience jusqu'à son terme.",
      "japanese": "彼は危険を認識していたにもかかわらず、実験を最後まで続けた。",
      "points": [
        "fût = 接続法半過去",
        "poursuivit = 単純過去"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "単純過去・接続法半過去",
      "french": "Elle souhaitait que les négociations aboutissent avant que la situation ne devînt irréversible.",
      "japanese": "彼女は状況が取り返しのつかないものになる前に交渉がまとまることを望んでいた。",
      "points": [
        "devînt = devenir の接続法半過去",
        "ne explétif"
      ]
    },
    {
      ...
      "french": "En croisant plusieurs sources indépendantes, les journalistes ont pu confirmer l'essentiel des faits.",
      "japanese": "複数の独立した情報源を照合することで、記者たちは事実の主要部分を確認できた。",
      "points": [
        "en croisant = ジェロンディフ",
        "手段を表す"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "現在分詞・ジェロンディフ",
      "french": "La mesure, visant à réduire les délais administratifs, a pourtant créé de nouvelles étapes de contrôle.",
      "japanese": "行政手続きの期間短縮を目指すその措置は、しかし新たな確認段階を生み出した。",
      "points": [
        "visant à = 現在分詞",
        "名詞 mesure を補足説明"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "現在分詞・ジェロンディフ",
      "french": "Sachant que les données étaient incomplètes, l'équipe a présenté ses conclusions avec prudence.",
      "japanese": "データが不完全だと分かっていたため、チームは慎重に結論を示した。",
      "points": [
        "sachant que = 現在分詞構文",
        "理由・前提"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "現在分詞・ジェロンディフ",
      "french": "Tout en reconnaissant les progrès accomplis, le rapport insiste sur les difficultés qui subsistent.",
      "japanese": "達成された進展を認めつつも、報告書は残る問題を強調している。",
      "points": [
        "tout en + gérondif = 〜しつつ",
        "insister sur"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "現在分詞・ジェロンディフ",
      "french": "En privilégiant uniquement les résultats à court terme, on risque de négliger des effets qui apparaissent plus tard.",
      "japanese": "短期的な結果だけを優先すると、後になって現れる影響を見落とすおそれがある。",
      "points": [
        "en privilégiant = ジェロンディフ",
        "条件・手段"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "現在分詞・ジェロンディフ",
      "french": "Les chercheurs travaillant sur le projet ont demandé un accès plus large aux données brutes.",
      "japanese": "そのプロジェクトに取り組む研究者たちは、生データへのより広いアクセスを求めた。",
      "points": [
        "travaillant = 現在分詞",
        "名詞 researchers を修飾"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "現在分詞・ジェロンディフ",
      "french": "Ne disposant d'aucune preuve directe, l'enquêteur s'est gardé de tirer une conclusion définitive.",
      "japanese": "直接的な証拠がなかったため、調査官は最終的な結論を出すことを控えた。",
      "points": [
        "ne disposant de = 否定の現在分詞",
        "se garder de = 〜を控える"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "現在分詞・ジェロンディフ",
      "french": "En modifiant progressivement les paramètres, l'équipe a identifié la variable responsable de l'écart observé.",
      "japanese": "パラメータを段階的に変えることで、チームは観察された差の原因となる変数を特定した。",
      "points": [
        "en modifiant = ジェロンディフ",
        "responsable de"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "現在分詞・ジェロンディフ",
      "french": "Une réglementation imposant les mêmes obligations à toutes les entreprises peut avoir des effets très différents selon leur taille.",
      "japanese": "すべての企業に同じ義務を課す規制でも、企業規模によって影響は大きく異なりうる。",
      "points": [
        "imposant = 現在分詞",
        "selon = 〜によって"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "現在分詞・ジェロンディフ",
      "french": "En prétendant simplifier le débat, cette opposition entre deux camps finit souvent par masquer la diversité des positions.",
      "japanese": "議論を単純化しようとすることで、二陣営の対立という構図はしばしば立場の多様性を覆い隠してしまう。",
      "points": [
        "en prétendant = ジェロンディフ",
        "finir par = 結局〜する"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "複合過去・半過去",
      "french": "Alors que l'entreprise affichait encore des bénéfices importants, elle a annoncé la fermeture de deux sites jugés insuffisamment rentables.",
      "japanese": "企業がなお大きな利益を計上していた一方で、採算性が不十分とされた2拠点の閉鎖を発表した。",
      "points": [
        "affichait = 背景・継続状態",
        "a annoncé = 出来事"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "複合過去・半過去",
      "french": "Les négociations avançaient lentement lorsqu'un changement de gouvernement a entièrement modifié les priorités.",
      "japanese": "交渉がゆっくり進んでいたところ、政権交代によって優先事項が全面的に変わった。",
      "points": [
        "avançaient = 進行中",
        "a modifié = 転換点"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "複合過去・半過去",
      "french": "On pensait jusque-là que le phénomène restait marginal, mais plusieurs études ont montré qu'il concernait une part croissante de la population.",
      "japanese": "それまではその現象は限定的だと考えられていたが、複数の研究が人口のますます大きな割合に関係していることを示した。",
      "points": [
        "pensait / restait = 背景的認識",
        "ont montré = 新しい出来事"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "複合過去・半過去",
      "french": "Pendant que les équipes préparaient le lancement, un fournisseur essentiel a annoncé qu'il ne pourrait pas respecter les délais.",
      "japanese": "各チームが発売準備を進める中、重要な供給業者が期限を守れないと発表した。",
      "points": [
        "préparaient = 継続中",
        "a annoncé = 割り込み"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "複合過去・半過去",
      "french": "Le quartier changeait rapidement depuis plusieurs années lorsque la municipalité a décidé de limiter les locations de courte durée.",
      "japanese": "その地区が数年にわたり急速に変化していた中、市は短期賃貸を制限することを決めた。",
      "points": [
        "changeait depuis = 継続",
        "a décidé = 決定"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "複合過去・半過去",
      "french": "Je relisais les résultats pour vérifier un détail quand j'ai remarqué une incohérence dans le tableau principal.",
      "japanese": "細部を確認するため結果を読み返していたとき、主要な表の不整合に気づいた。",
      "points": [
        "relisais = 進行中",
        "ai remarqué = 発見"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "複合過去・半過去",
      "french": "La plupart des observateurs s'attendaient à une baisse des ventes, mais la demande a finalement augmenté pendant l'été.",
      "japanese": "多くの観測者は売上減を予想していたが、需要は最終的に夏の間に増加した。",
      "points": [
        "s'attendaient = 背景の予想",
        "a augmenté = 実現した変化"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "複合過去・半過去",
      "french": "Au moment où les autorités cherchaient encore une solution provisoire, la situation s'est brusquement aggravée.",
      "japanese": "当局がまだ暫定的な解決策を探していたとき、状況は突然悪化した。",
      "points": [
        "cherchaient = 継続中",
        "s'est aggravée = 急な変化"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "複合過去・半過去",
      "french": "Le chercheur croyait avoir contrôlé tous les paramètres jusqu'au jour où une expérience a produit un résultat inattendu.",
      "japanese": "研究者は、ある実験が予想外の結果を出すまでは、すべての条件を制御できていると思っていた。",
      "points": [
        "croyait = 継続的認識",
        "a produit = 転換点"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "複合過去・半過去",
      "french": "Les habitants demandaient depuis longtemps davantage de transports publics lorsque la région a finalement adopté un nouveau plan.",
      "japanese": "住民が長年公共交通の拡充を求めていた中、地域政府はついに新しい計画を採択した。",
      "points": [
        "demandaient depuis = 継続",
        "a adopté = 完了した決定"
      ]
    },
    {
      ...
      "french": "Les conclusions de cette enquête diffèrent sensiblement de celles publiées l'année précédente.",
      "japanese": "この調査の結論は前年に公表されたものとかなり異なる。",
      "points": [
        "celles = conclusions を受ける",
        "participe passé による修飾"
      ]
    },
    {
      "id": 382,
      "level": "B2",
      "category": "指示代名詞・所有代名詞",
      "french": "Parmi les scénarios envisagés, celui qui suppose une croissance constante paraît le moins réaliste.",
      "japanese": "検討されたシナリオのうち、一定の成長を前提とするものが最も現実的でないように見える。",
      "points": [
        "celui qui = 〜するもの",
        "supposer = 前提とする"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "指示代名詞・所有代名詞",
      "french": "Les difficultés rencontrées par les petites entreprises ne sont pas toujours les mêmes que celles auxquelles font face les grands groupes.",
      "japanese": "小規模企業が直面する問題は、大企業が直面するものと必ずしも同じではない。",
      "points": [
        "celles auxquelles = 〜が直面するもの",
        "faire face à"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "指示代名詞・所有代名詞",
      "french": "Il a rejeté la première hypothèse pour retenir celle selon laquelle l'erreur provenait du protocole lui-même.",
      "japanese": "彼は最初の仮説を退け、誤りは手順そのものに由来するという仮説を採用した。",
      "points": [
        "celle selon laquelle = 〜というもの",
    ...
    },
    {
      ...
      "level": "B2",
      "category": "指示代名詞・所有代名詞",
      "french": "Les arguments avancés par l'opposition sont plus détaillés que ceux du rapport officiel.",
      "japanese": "野党が示した論拠は公式報告書のものより詳しい。",
      "points": [
        "ceux de = 〜のもの",
        "arguments を受ける"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "指示代名詞・所有代名詞",
      "french": "Notre interprétation reste provisoire; la leur repose sur des données plus anciennes.",
      "japanese": "私たちの解釈は暫定的なままだが、彼らのものはより古いデータに基づいている。",
      "points": [
        "la leur = 彼らのもの",
        "reposer sur = 〜に基づく"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "指示代名詞・所有代名詞",
      "french": "Sa responsabilité n'est pas identique à la mienne, même si nos décisions ont été prises ensemble.",
      "japanese": "彼の責任は私のものと同じではない。たとえ私たちの決定が共同で下されたとしても。",
      "points": [
        "la mienne = 私のもの",
        "même si + 直説法"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "指示代名詞・所有代名詞",
      "french": "Leur stratégie privilégie la croissance rapide, tandis que la nôtre vise surtout la stabilité à long terme.",
      "japanese": "彼らの戦略は急速な成長を優先する一方、私たちの戦略は主に長期的な安定を目指す。",
      "points": [
        "la nôtre = 私たちのもの",
        "tandis que = 〜する一方で"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "指示代名詞・所有代名詞",
      "french": "Certains indicateurs se sont améliorés, notamment ceux qui mesurent l'accès aux services essentiels.",
      "japanese": "いくつかの指標は改善しており、特に基礎的サービスへのアクセスを測る指標がそうである。",
      "points": [
        "ceux qui = 〜するもの",
        "notamment = とりわけ"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "指示代名詞・所有代名詞",
      "french": "Les priorités nationales ne coïncident pas nécessairement avec celles des collectivités locales.",
      "japanese": "国の優先事項は地方自治体のものと必ずしも一致しない。",
      "points": [
        "celles de = 〜のもの",
        "coïncider avec"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "否定構文",
      "french": "La réforme n'a ni réduit les délais ni simplifié les démarches autant qu'on l'espérait.",
      "japanese": "改革は期待されたほど手続き期間を短縮も簡素化もしなかった。",
      "points": [
        "ne... ni... ni...",
        "動詞句を二つ否定"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "否定構文",
      "french": "Le rapport ne confirme ni l'hypothèse initiale ni celle proposée par l'équipe concurrente.",
      "japanese": "報告書は当初の仮説も競合チームが提案した仮説も裏づけていない。",
      "points": [
        "ne... ni... ni...",
        "celle = hypothèse を受ける"
      ]
    },
    {
      "id": 393,
      "level": "B2",
      "category": "否定構文",
      "french": "Les auteurs ne s'attardent guère sur les conséquences sociales de la mesure.",
      "japanese": "著者たちはその措置の社会的影響についてほとんど詳しく論じていない。",
      "points": [
        "ne... guère = ほとんど〜ない",
        "s'attarder sur"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "否定構文",
      "french": "Cette distinction, pourtant essentielle, n'apparaît guère dans le débat public.",
      "japanese": "この区別は重要であるにもかかわらず、公の議論ではほとんど見られない。",
      "points": [
        "ne... guère",
        "pourtant = それにもかかわらず"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "否定構文",
      "french": "Aucune des explications avancées ne rend entièrement compte des écarts observés.",
      "japanese": "提示された説明のどれも、観察された差を完全には説明していない。",
      "points": [
        "aucune de... ne",
        "rendre compte de = 〜を説明する"
      ]
    },
    {
      "id": 396,
      "level": "B2",
      "category": "否定構文",
      "french": "Il n'existe aucune preuve permettant d'affirmer que l'effet persistera à long terme.",
      "japanese": "その効果が長期的に続くと断言できる証拠は何も存在しない。",
      "points": [
        "ne... aucune",
        "permettant de = 〜を可能にする"
      ]
    },
    {
      "id": 397,
      "level": "B2",
      "category": "否定構文",
      "french": "Personne ne saurait sérieusement prétendre que les deux situations sont parfaitement comparables.",
      "japanese": "二つの状況が完全に比較可能だと本気で主張できる者はいない。",
      "points": [
        "personne ne saurait + 不定詞",
        "条件法による婉曲・不可能"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "否定構文",
      "french": "Rien ne permet encore d'exclure l'hypothèse d'une erreur de mesure.",
      "japanese": "測定誤差の可能性を排除できる根拠はまだ何もない。",
      "points": [
        "rien ne permet de",
    ...
    },
    {
      ...
      "level": "B2",
      "category": "否定構文",
      "french": "La nouvelle procédure n'est pas sans risques, même si elle offre davantage de garanties que l'ancienne.",
      "japanese": "新しい手続きにはリスクがないわけではないが、旧手続きより多くの保障を備えている。",
      "points": [
        "ne pas être sans = 〜がないわけではない",
        "même si"
      ]
    },
    {
      ...
      "level": "B2",
      "category": "否定構文",
      "french": "On ne peut ni ignorer les progrès réalisés ni considérer qu'ils suffisent à résoudre l'ensemble du problème.",
      "japanese": "達成された進展を無視することも、それだけで問題全体を解決できると考えることもできない。",
      "points": [
        "ne pouvoir ni... ni...",
        "suffire à + 不定詞"
      ]
